...
/* 
    Titulo: Sistema de Cursos virtuales (SVC05)
    Autor: Brian Marquez
    Fecha de Creación: 20-11-2024 ✔️
    Descripción: creacion de modelo logico
    Resumen de cambios: se creo la version V5
*/ 
...
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Arequipa', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Alto Selva Alegre', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Cayma', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Cerro Colorado',10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Characato', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Chiguata', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Jacobo Hunter', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('La Joya', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Mariano Melgar', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Miraflores', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Mollebaya', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Paucarpata', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Pocsi', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Polobaya', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Quequeña', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Sabandía', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Sachaca', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('San Juan de Siguas', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('San Juan de Tarucani', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Santa Isabel de Siguas', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Santa Rita de Siguas', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Socabaya', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Tiabaya', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Uchumayo', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Vítor', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Yanahuara', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Yarabamba', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('Yura', 10)
INSERT [dbo].[tblDistritos] ([CnomDist], [provincia_id]) VALUES ('José Luis Bustamante y Rivero', 10)
...
select * from tblFeedback   -- TABLA FEEBACK
select * from tblRespuestas   -- TABLA DE RESPUESTAS

select * from systCod   -- TABLAS CODIGOS DEL LAS TABLAS (SYSTCRE)
select * from sysTab    -- DESCRIPCION DE LA TABLA
...
VALUES
           ...
           (34, 'Los ejercicios propuestos son desafiantes y educativos.', GETDATE()),
           (35, 'La plataforma es fácil de usar y muy intuitiva.', GETDATE()),
           (35, 'Me gustaría que se extendiera el tiempo de acceso al curso.', GETDATE()),
           (35, 'El tema está bien explicado, pero faltan ejemplos.', GETDATE()),
           (36, 'Recomendaré este curso a mis amigos.', GETDATE()),
           (36, 'La calidad de los videos es excelente.', GETDATE()),
           (36, 'El curso fue demasiado básico para mi nivel.', GETDATE()),
           ...
           (37, 'El curso tiene una estructura muy clara.', GETDATE()),
           (37, 'No logré completar el curso debido a problemas técnicos.', GETDATE()),
           (38, 'El precio del curso es muy accesible.', GETDATE()),
           (38, 'Me ayudó mucho en mi trabajo diario.', GETDATE()),
           (39, 'El certificado fue entregado rápidamente.', GETDATE()),
           (40, 'Me gustaría ver cursos más avanzados sobre este tema.', GETDATE())
GO
...
--TABLAS DEL SISTEMAS
select * from sysdLog       --q
select * from systCod		-- q
select * from systTab       --q

-- LOGICA
select * from tblCursos       --q
select * from tblRoles        --q
select * from tblUsuarios     -- q

select * from tblCalificaciones  --q
select * from tblEvaluaciones    --q
select * from tblModulos         --q
select * from tblInscripciones   --q
select * from tblFeedback	     --q
select * from tblRespuestas      --q
select * from tblResultados      --q

-- UBIGEO
select * from tblDepartamentos  --q
select * from tblDistritos      --q
select * from tblPaises         --q
select * from tblProvincias     --q
